...
module.exports = {
	...
	// Style options.
	styleSRC: './_dev/scss/style.scss', // Path to main .scss file.
	...
	// JS Custom options.
	jsCustomSRC: './_dev/js/custom1.js', // Path to JS custom scripts folder.
	...
	// Watch files paths.
	watchStyles: './_dev/scss/*.scss', // Path to all *.scss files inside css folder and inside them.
	watchJsVendor: './_dev/js/vendor/*.js', // Path to all vendor JS files.
	watchJsCustom: './_dev/js/custom1.js', // Path to all custom JS files.
